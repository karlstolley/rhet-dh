...
When I declare that “programming is writing,” I am talking about writing source code right alongside or in service to natural languages. More than 30 years of visual interfaces interceding on behalf of writers and language (computer and natural) have arguably almost fully obscured the rich symbolic activity happening just beneath even the touch-screen on an iPad. The remaining symbolic activity that hasn’t been obscured is perceived to be simply beyond our symbolic concerns as writers and rhetoricians. What could be more preposterous than writers programming, when an app store app or an open-source package is readily available for download and installation? Shouldn’t writers, as Bill Hart-Davidson has suggested, simply outsource programming to other people? (http://www.digitalrhetoriccollaborative.org/2012/10/17/code-not-so-much/)

Such questions belie an impoverished, even ham-fisted conception of what programming is and what it does, or can do, because they arrest any consideration of the symbolic materiality and activity at programming’s core. Such questions, in other words, discourage the deep, long-term involvement with the digital medium that I believe is necessary to engage programmers and developers who are doing so much writing, so much rhetoric--even when we think, as Hart-Davidson seems to, that they’re simply translating/programming *our* ideas and making them reality.

Writers and rhetoricians taking up those kinds of positions close down the richer encounters with the digital medium that may genuinely move the field of rhetoric forward, and put us into broader conversations with other rhetorical pursuits in that medium--especially programming.

Jay David Bolter’s simple 1991 observation seems all but forgotten today: “Even a graphics program does not draw: it writes.” Working at a time before the introduction of Microsoft Windows 3.1 and the mouse-and-GUI model of interaction that that operating system would make ubiquitous, Bolter could confidently proclaim what is less obvious today: “All computing is reading and writing. The computer is therefore a technology for all writers--scientists and engineers as well as scholars, novelists, and poets” (10).
...
The key word there is “activities.” It is not simply the created artifact, or the source code behind it, providing the affordances of intellectual work. It is the activity of programming itself that builders, writers-as-programmers must present. This activity, I believe, will ultimately present itself as “theorizing” as Ramsay and Rockwell seem to hope. But the path to theorization may very well look different from simply demonstrating to others a “rich and provocative” set of affordances meant to *metaphorically* suggest “programming is writing.” That’s a path carved out by the values and methods of literary studies (values being carried forward in the most pernicious ways by so-called “software studies”).

Rhetoric should not be beholden to the values and methods of literary studies to make an immediate leap to “theorization” inherent in, for example, text-analysis and other computationally intensive, supposedly objective modes of digital inquiry. Our roots as a practical art, embracing theory as well as techne and craft, must be brought to the fore in order to render the practice of programming as a knowledge-generating, epistemological activity within the province of rhetoric.
