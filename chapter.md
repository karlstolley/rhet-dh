...
The situation is different, however, in web development frameworks such as Ruby on Rails (a full Rails app is available with additional commentary via this book’s companion website). There isn’t room in this chapter for a full technical description of Ruby on Rails, but it’s enough for now to note that Rails is an open-source web-application development framework written in the Ruby programming language.
...
Covino writes that “even in our nonmagical world, magic remains a conceptual construct for appraising the powers of language, and while magic is understood by some as a liberatory alternative to established rationalism, the prospect of a magical epistemology is a fearful one even for those who endorse literacy as a disruptive force” (1994, 5). Programming presents itself as magic to the uninitiated. I have witnessed that even the simple prospect of programming can arrest into silent hostility digital humanists who otherwise “endorse literacy as a disruptive force” and who ostensibly delight in an ever greater “range and intenseness” of symbolic activity (as Burke [1966] suggests in the epigraph to this chapter).

In addition to the privileging of literary modes of inquiry that I noted above, there is also a problem within the humanities and the mythos of programming as a mysterious and magical activity. That mythos is perhaps reinforced by the intercession of so many screens and interfaces that provide both a sanctioned, visual kind of magic and tacit promises of protection from a disruptive, unpredictable textual kind of magic.
